...
#if 0
    用链表的方式解决hash冲突问题
    HashClass hashobj(16);
    hashobj.MakeHash();
    hashobj.InsertHash(10);
    hashobj.InsertHash(25);
    hashobj.InsertHash(26);
    hashobj.InsertHash(58);
    hashobj.InsertHash(42);

    std::cout << hashobj.GetHash(26) << std::endl;
    hashobj.DisplayHash(10);
    hashobj.DelHash(10);
    std::cout << hashobj.GetHash(10) << std::endl;
#endif

#if 0
    桶排序
    double a[10] = {0.131,0.4243,0.11,0.094,0.5763,0.876,0.24,0.004,0.11666,0.8211};
    BucketSort(a, sizeof(a)/sizeof(double));
#endif
